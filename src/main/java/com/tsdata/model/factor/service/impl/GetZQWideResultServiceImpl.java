 ...
 *
 */
@Service("ZQWideHandler")
public class GetZQWideResultServiceImpl implements GetInterfaceInfoService{
	public static Logger logger = LoggerFactory.getLogger(GetZQWideResultServiceImpl.class);
	...
	public JSONObject getResult(JSONObject param) {
		...
		String responseBody = HttpUtil.doDispatcher(riskUrl, HttpUtil.Request.METHOD_POST, requestParam ,header()).responseBody;
